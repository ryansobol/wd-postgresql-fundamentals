...
module.exports.selectCheapestDish = function(knex) {
  const subquery = knex('dishes').min('cost as c').select('c').then(function(el){
    console.log(el);
  });
...
// module.exports.//something = function(knex) {
//   return knex('some DB').//some knex query('some thing');
// }
