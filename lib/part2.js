...
//    knex (knex object)
//
// Return a SQL command, as a string, that selects all rows and columns from the
// restaurants table
...
//    knex (knex object)
//
// Return a SQL command, as a string, that selects all rows but only the name
// column of the restaurants table
